...
import { AppShell, ThemeProvider } from "./index";
...
describe("responsive application shell", () => {
  it("opens mobile navigation and command palette accessibly", async () => {
    ...
    render(<ThemeProvider><AppShell portalLabel="Platform operations" navigation={navigation}><p>Dashboard content</p></AppShell></ThemeProvider>);
