...
export const registerSchema = z.object({ displayName: z.string().trim().min(2, "Enter your name").max(150), email: emailSchema, password: passwordSchema, invitationKey: z.string().trim().min(24, "Enter a valid invitation key") });
